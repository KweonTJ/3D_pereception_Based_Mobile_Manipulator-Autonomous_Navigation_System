...
private:
  ...
  std::optional<cv::Mat> imageMsgToBgr(const sensor_msgs::msg::Image::ConstSharedPtr & msg) const;
  std::optional<cv::Mat> depthMsgToBgr(const sensor_msgs::msg::Image::ConstSharedPtr & msg) const;
