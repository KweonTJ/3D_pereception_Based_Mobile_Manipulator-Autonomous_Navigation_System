...
def generate_launch_description():
    ...
    hardware_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "stay_pose_joint_trajectory_topic": joint_trajectory_output_topic,
    ...
    auto_init_bbox_node = Node(
        ...
        parameters=[{
            ...
            "yolo_min_accept_confidence": 0.12,
            "yolo_locked_min_accept_confidence": 0.20,
            ...
            "yolo_lock_reset_after_misses": 0,
            "yolo_center_score_weight": 0.30,
            "yolo_area_score_weight": 0.35,
            "bbox_padding_scale_x": 1.45,
            "bbox_padding_scale_y": 1.15,
    ...
    auto_eef_init_bbox_node = Node(
        ...
        parameters=[{
            ...
            "yolo_max_detections": ParameterValue(auto_init_yolo_max_detections, value_type=int),
            "yolo_lock_target": True,
            "yolo_min_accept_confidence": 0.20,
            "yolo_locked_min_accept_confidence": 0.20,
            "yolo_max_center_jump_ratio": 0.16,
            "yolo_anchor_max_center_jump_ratio": 0.60,
            "yolo_min_reselect_iou": 0.00,
            "yolo_min_area_ratio_change": 0.20,
            "yolo_max_area_ratio_change": 3.50,
            "yolo_lock_reset_after_misses": 2,
            "yolo_center_score_weight": 0.60,
            "yolo_area_score_weight": 0.15,
            "bbox_padding_scale_x": 1.10,
